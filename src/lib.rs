...
pub const VOWELS: &[char] = &['a', 'e', 'i', 'o', 'u', 'y', 'A', 'E', 'I', 'O', 'U', 'Y'];
...
impl ISV {
    pub fn get_present_tense_stem(infinitive: &str) -> (String, Conjugation) {
        ...
        } else if infinitive.ends_with("nuti") {
            (infinitive.replace("nutj", "n"), Conjugation::First)
        } else if infinitive.ends_with("atj") {
            (
                ISVUTILS::replace_last_occurence(infinitive, "atj", "aj"),
                Conjugation::First,
            )
        } else if infinitive.ends_with("etj") {
            (
                ISVUTILS::replace_last_occurence(infinitive, "etj", "ej"),
                Conjugation::First,
            )
        } else if infinitive.ends_with("entj") {
            (
                ISVUTILS::replace_last_occurence(infinitive, "entj", "n"),
                Conjugation::First,
            )
        } else if infinitive.ends_with("ytj") {
            (
                ISVUTILS::replace_last_occurence(infinitive, "ytj", "yj"),
                Conjugation::First,
            )
        } else if infinitive.ends_with("utj") {
            (
                ISVUTILS::replace_last_occurence(infinitive, "utj", "uj"),
                Conjugation::First,
            )
        } else if infinitive.ends_with("itj") {
            (
                ISVUTILS::replace_last_occurence(infinitive, "itj", ""),
                Conjugation::Second,
            )
        } else if infinitive.ends_with("jetj") {
            (
                ISVUTILS::replace_last_occurence(infinitive, "jetj", ""),
                Conjugation::Second,
            )
        } else {
            ...
            for entry in J_MERGE_CHARS {
                if root.ends_with(entry) {
                    let new_root = match *entry {
                        "st" => ISVUTILS::replace_last_occurence(root, entry, "szc"),
                        "zd" => ISVUTILS::replace_last_occurence(root, entry, "zzdzz"),
                        "sk" => ISVUTILS::replace_last_occurence(root, entry, "szcz"),
                        "zg" => ISVUTILS::replace_last_occurence(root, entry, "zzzz"),
                        "s" => ISVUTILS::replace_last_occurence(root, entry, "sz"),
                        //  "z" => ISVUTILS::replace_last_occurence(root, entry, "zz"),
                        "t" => ISVUTILS::replace_last_occurence(root, entry, "c"),
                        "d" => ISVUTILS::replace_last_occurence(root, entry, "dzz"),
                        "k" => ISVUTILS::replace_last_occurence(root, entry, "cz"),
                        "g" => ISVUTILS::replace_last_occurence(root, entry, "zz"),
                        "h" => ISVUTILS::replace_last_occurence(root, entry, "sz"),
                        _ => root.to_string(),
                    };
